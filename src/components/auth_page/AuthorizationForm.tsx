...
export const AuthorizationForm = () => {
    ...
    const yandexAuthorizeUrl = `https://oauth.yandex.ru/authorize?response_type=token&client_id=${process.env.REACT_APP_YANDEX_CLIENT_ID}&redirect_uri=${process.env.REACT_APP_CLIENT_URL}`;
