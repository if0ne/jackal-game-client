    ...
    return (
        <ContainerComponent className="my-4">
            ...
            }
            {
                ...
                <Row>
                    <Col sm={4}>
                        <button className="btn-avatar" onMouseEnter={() => setButtonPopup("Изменить")} onMouseLeave={() => setButtonPopup("")}>
                    ...
                    <Col sm={8}>
                        <h1>
                            <span>{user.name}</span>
                            <Button variant="light" className="mx-2" disabled>{pencil()}</Button>
                        </h1>
                    </Col>
                </Row>
            }
